...
var productImagePath = 'assets/images-demo/products/';
var products = [{
  name: 'Silver Watch',
...
var HorizontalProducts = function (_React$Component) {
  _inherits(HorizontalProducts, _React$Component);
  ...
  function HorizontalProducts() {
    ...
    _classCallCheck(this, HorizontalProducts);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HorizontalProducts.__proto__ || Object.getPrototypeOf(HorizontalProducts)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      products: products
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(HorizontalProducts, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('section', { className: 'container-fluid with-maxwidth-lg no-breadcrumbs chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement('div', null, this.state.products.map(function (product, index) {
        return _react2.default.createElement('div', { className: 'item-card card__horizontal', key: index }, _react2.default.createElement('div', { className: 'card__image' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('img', { alt: 'product', src: product.img }))), _react2.default.createElement('div', { className: 'card__body card-white' }, _react2.default.createElement('div', { className: 'card__title' }, _react2.default.createElement('h4', null, product.name), _react2.default.createElement('h6', null, 'Accessories')), _react2.default.createElement('div', { className: 'card__price' }, _react2.default.createElement('span', { className: 'type--strikethrough' }, '$699.99'), _react2.default.createElement('span', null, '$649.99')), _react2.default.createElement('div', { className: 'divider divider-solid divider-lg' }), _react2.default.createElement('p', { className: 'card__desc' }, 'From the way it works to the way it looks, Watch isn\u2019t just something you wear. It\u2019s an essential part of who you are.')));
      })))));
    }
  }]);
...
//# sourceMappingURL=53.app.js.map