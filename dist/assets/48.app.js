...
var Hero = function Hero() {
  return _react2.default.createElement('section', { className: 'hero hero-bg-img', style: { backgroundImage: 'url(assets/images-demo/covers/photo-1438893761775-f1db119d27b2.jpg)' } }, _react2.default.createElement('div', { className: 'hero-inner' }, _react2.default.createElement('div', { className: 'hero-content' }, _react2.default.createElement('h1', { className: 'hero-title' }, 'About Us')), _react2.default.createElement('p', { className: 'hero-tagline' }, 'Everything you need to know about our Company')));
};

var Info = function Info() {
  return _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('article', { className: 'article' }, _react2.default.createElement('div', { className: 'row stat-container' }, _react2.default.createElement('div', { className: 'col-md-4' }, _react2.default.createElement('section', { className: 'stat-item' }, _react2.default.createElement('span', { className: 'stat-num' }, '10'), _react2.default.createElement('span', { className: 'stat-desc' }, 'Years Experience')), _react2.default.createElement('p', null, 'Necessitatibus eaque, deleniti error in quam fuga et nisi facere dolore excepturi accusamus dicta reprehenderit dolor. Quo necessitatibus possimus ipsam, nesciunt aspernatur ex libero asperiores, debitis minus nostrum odio. Sunt dolore, dolorem id, iusto quia est unde a doloribus doloremque quisquam repellat nobis enim ipsam eligendi perspiciatis, provident eos aliquid. ')), _react2.default.createElement('div', { className: 'col-md-4' }, _react2.default.createElement('section', { className: 'stat-item' }, _react2.default.createElement('span', { className: 'stat-num' }, '200+'), _react2.default.createElement('span', { className: 'stat-desc' }, 'Satisfied Clients')), _react2.default.createElement('p', null, 'Tempore adipisci ea accusamus odit consequuntur! Quaerat quos nemo qui ipsam accusantium, nostrum error nesciunt quibusdam velit tempore odit deleniti animi laborum sequi saepe minima atque! Nobis repellendus quos voluptatum sapiente, eveniet aliquid ex eum explicabo soluta delectus officia, dolore aspernatur, dicta nam placeat nostrum aliquam magni? Iste, hic, mollitia.')), _react2.default.createElement('div', { className: 'col-md-4' }, _react2.default.createElement('section', { className: 'stat-item' }, _react2.default.createElement('span', { className: 'stat-num' }, '12'), _react2.default.createElement('span', { className: 'stat-desc' }, 'Kinds of Products')), _react2.default.createElement('p', null, 'Nostrum, laudantium minima nam dolorum quasi, ut sunt, dolore ratione suscipit sequi vero ducimus earum praesentium odit aut amet voluptates, sint doloribus omnis. Dignissimos, similique neque praesentium mollitia, libero delectus in adipisci ex nihil laborum iure quaerat magnam obcaecati repellendus exercitationem explicabo! Eum, ut voluptatum sapiente dignissimos unde quae eos quis mollitia, voluptate, dolores excepturi? ')))));
};

var Culture = function Culture() {
  return _react2.default.createElement('article', { className: 'article padding-lg-v article-bordered' }, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-3' }, _react2.default.createElement('h5', { className: 'no-margin-top' }, 'OUR CULTURE')), _react2.default.createElement('div', { className: 'col-xl-9' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-primary' }), _react2.default.createElement('strong', null, 'Strong sense of purpose'), ' ', _react2.default.createElement('br', null), 'We want to help everyone build their brands and identity online.')), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-info' }), _react2.default.createElement('strong', null, 'Relentless focus on success'), ' ', _react2.default.createElement('br', null), 'Get rid of your excuses. Take pride in getting shit done.')), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-success' }), _react2.default.createElement('strong', null, 'New ideas on how to do things better'), ' ', _react2.default.createElement('br', null), 'Question everything. Don\'t fall into the status-quo trap. Innovate!'))), _react2.default.createElement('div', { className: 'divider divider-lg' }), _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-warning' }), _react2.default.createElement('strong', null, 'High bar for quality'), ' ', _react2.default.createElement('br', null), 'We\'re obsessed with building the best and always see room for improvement.')), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-danger' }), _react2.default.createElement('strong', null, 'Embrace the challenge'), ' ', _react2.default.createElement('br', null), 'Uncertainty is always part of a startup. We tackle big ideas with courage.')), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('p', null, _react2.default.createElement('span', { className: 'space-bar bg-color-dark' }), _react2.default.createElement('strong', null, 'Simplify'), ' ', _react2.default.createElement('br', null), 'To create the best experience, we cut all distractions and get to the point.')))))));
};

var About = function About() {
  return _react2.default.createElement('section', { className: 'page-about chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Hero, null)), _react2.default.createElement('div', { key: '2' }, _react2.default.createElement(Info, null)), _react2.default.createElement('div', { key: '3' }, _react2.default.createElement(Culture, null))));
};
