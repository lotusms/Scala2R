...
var Timeline = exports.Timeline = function Timeline() {
  return _react2.default.createElement('div', { className: 'ui-timline-container' }, _react2.default.createElement('section', { className: 'ui-timeline' }, _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-caption' }, _react2.default.createElement('a', { href: 'javascript:;', className: 'btn btn-primary btn-block' }, 'Today'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '3 min ago'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-info' }, _react2.default.createElement('i', { className: 'material-icons' }, 'camera')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-primary' }, 'Go hiking'), _react2.default.createElement('p', null, 'Consectetur adipisicing elit. Error, accusantium debitis voluptatem dolore excepturi ducimus fugiat nulla perspiciatis quo ipsum non eligendi nisi veniam maxime in quas atque omnis cumque!'))))), _react2.default.createElement('article', { className: 'tl-item alt' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '1 hour ago'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-warning' }, _react2.default.createElement('i', { className: 'material-icons' }, 'shopping_cart')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-danger' }, 'Buy some toys'), _react2.default.createElement('p', null, 'Ullam, commodi, modi, impedit nostrum odio sit odit necessitatibus accusantium enim voluptates culpa cupiditate cum pariatur a recusandae tenetur aspernatur at beatae.'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '3 hours ago'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-success' }, _react2.default.createElement('i', { className: 'material-icons' }, 'camera')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-warning' }, 'Soluta nihil'), _react2.default.createElement('p', null, 'Incidunt, molestias odio soluta nihil accusantium sit nostrum doloremque. Recusandae, ullam, odio consequatur facere totam reiciendis similique dicta explicabo!'))))), _react2.default.createElement('article', { className: 'tl-item alt' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '7 hours ago'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-danger' }, _react2.default.createElement('i', { className: 'material-icons' }, 'check')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-success' }, 'Odio sit odit necessitatibus'), _react2.default.createElement('p', null, 'Ullam, commodi, modi, impedit nostrum odio sit odit necessitatibus accusantium enim voluptates culpa cupiditate cum pariatur a recusandae tenetur aspernatur at beatae.'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '10 hours ago'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-primary' }, _react2.default.createElement('i', { className: 'material-icons' }, 'alarm')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-info' }, 'Accusantium sint'), _react2.default.createElement('p', null, 'Ipsam, minus, quam, sit officiis accusantium sint voluptates voluptatibus minima cum non quos corrupti dolorem eligendi modi eius magnam unde!'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-caption' }, _react2.default.createElement('a', { href: 'javascript:;', className: 'btn btn-danger btn-block' }, 'Yesterday'))))), _react2.default.createElement('article', { className: 'tl-item alt' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '8:30 PM'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-warning' }, _react2.default.createElement('i', { className: 'material-icons' }, 'comment')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile' }, 'Enim asperiores facere'), _react2.default.createElement('p', null, 'Odit, iusto, dolorem, aut ipsum rem atque enim asperiores facere tempore explicabo omnis corporis hic! Molestias, dolores, iure esse at illo aliquam temporibus in eum cupiditate magni velit eveniet unde facilis quisquam numquam nihil atque tempore vitae porro maxime repellendus quas a sit repellat delectus expedita nam natus fugiat ut ipsam eaque voluptates omnis ratione?'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '7:00 PM'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-success' }, _react2.default.createElement('i', { className: 'material-icons' }, 'folder')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-warning' }, 'Illum veniam atque'), _react2.default.createElement('p', null, 'Illum veniam atque iste voluptatem eos saepe quisquam aperiam voluptatum sunt.'))))), _react2.default.createElement('article', { className: 'tl-item alt' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '12:55 PM'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-danger' }, _react2.default.createElement('i', { className: 'material-icons' }, 'folder')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-success' }, 'Voluptas molestias'), _react2.default.createElement('p', null, 'At, veniam, officia pariatur voluptas molestias nobis distinctio quo temporibus! Nisi, fugit, ipsum, veritatis, optio consectetur nam molestiae quidem placeat deleniti animi ad nobis iure modi eius recusandae odio adipisci nesciunt.'))))), _react2.default.createElement('article', { className: 'tl-item' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '10:13 AM'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-primary' }, _react2.default.createElement('i', { className: 'material-icons' }, 'email')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-info' }, 'Nulla magni sequi'), _react2.default.createElement('p', null, 'Laborum, ducimus, perferendis nulla magni sequi cumque nisi eum praesentium omnis voluptas id molestias adipisci accusamus nobis totam. Odit, hic suscipit necessitatibus quos'))))), _react2.default.createElement('article', { className: 'tl-item alt' }, _react2.default.createElement('div', { className: 'tl-body' }, _react2.default.createElement('div', { className: 'tl-entry' }, _react2.default.createElement('div', { className: 'tl-time' }, '9:10 AM'), _react2.default.createElement('div', { className: 'tl-icon btn-icon-round btn-icon btn-icon-thin btn-info' }, _react2.default.createElement('i', { className: 'material-icons' }, 'card_giftcard')), _react2.default.createElement('div', { className: 'tl-content' }, _react2.default.createElement('h4', { className: 'tl-tile text-primary' }, 'Sed cumque temporibus'), _react2.default.createElement('p', null, 'Deserunt sed cumque temporibus. Doloribus, iste, sit recusandae fugiat assumenda ea magni at doloremque ipsum amet molestias error mollitia maxime ad alias eos id cumque corporis placeat nisi a quaerat nemo magnam ab numquam ratione facere dolorum. Cumque, dolores, sint molestiae eaque quibusdam illo error!')))))));
};

var Page = function Page() {
  return _react2.default.createElement('div', { className: 'container-fluid with-maxwidth chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Timeline, null))));
};
