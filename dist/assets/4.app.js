...
var LockScreen = function (_React$Component) {
  ...
  function LockScreen() {
    ...
    var _this = _possibleConstructorReturn(this, (LockScreen.__proto__ || Object.getPrototypeOf(LockScreen)).call(this));
  ...
  _createClass(LockScreen, [{
    ...
    value: function render() {
      return _react2.default.createElement('div', { className: 'lock-container' }, _react2.default.createElement('section', { className: 'lock-box' }, _react2.default.createElement('div', { className: 'lock-user' }, this.state.user), _react2.default.createElement('div', { className: 'lock-img' }, _react2.default.createElement('img', { src: 'assets/images/g1.jpg', alt: '' })), _react2.default.createElement('div', { className: 'lock-pwd' }, _react2.default.createElement('form', null, _react2.default.createElement('div', { className: 'form-group' }, _react2.default.createElement('input', { type: 'password', placeholder: 'Password', className: 'form-control' }), _react2.default.createElement('a', { href: '#/', className: 'btn-submit' }, _react2.default.createElement('i', { className: 'material-icons' }, 'keyboard_arrow_right')))))));
    }
  }]);
...
var Page = function Page() {
  return _react2.default.createElement('div', { className: 'page-lock' }, _react2.default.createElement('div', { className: 'lock-centered clearfix' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(LockScreen, null)))));
};
