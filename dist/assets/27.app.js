...
var Section1 = function Section1() {
  return _react2.default.createElement('div', { className: 'feature-callout feature-content-right card-white image-pull clearfix' }, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'col-12 col-md-6 offset-md-6' }, _react2.default.createElement('div', { className: 'callout-feature-content' }, _react2.default.createElement('h2', null, 'Architecto odit fuga facere'), _react2.default.createElement('p', null, 'Culpa eveniet labore cupiditate at maiores dignissimos, nesciunt quam porro accusantium velit quas? Nam nobis, deleniti inventore consequuntur quos vero voluptatum nostrum error porro mollitia, accusantium distinctio nemo expedita ipsum quisquam laboriosam'), _react2.default.createElement(_RaisedButton2.default, { label: 'Try it Now', secondary: true })))), _react2.default.createElement('div', { className: 'col-12 col-md-6 feature-callout-image-pull', style: imgLeft }));
};

var Section2 = function Section2() {
  return _react2.default.createElement('div', { className: 'feature-callout feature-content-left card-white image-pull clearfix' }, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'col-12 col-md-6' }, _react2.default.createElement('div', { className: 'callout-feature-content' }, _react2.default.createElement('h2', null, 'Commodi molestiae, culpa eveniet'), _react2.default.createElement('p', null, 'Culpa eveniet labore cupiditate at maiores dignissimos, nesciunt quam porro accusantium velit quas? Nam nobis, deleniti inventore consequuntur quos vero voluptatum nostrum error porro mollitia, accusantium distinctio nemo expedita ipsum quisquam laboriosam'), _react2.default.createElement(_RaisedButton2.default, { label: 'Try it Now', secondary: true })))), _react2.default.createElement('div', { className: 'col-12 col-md-6 offset-md-6 feature-callout-image-pull', style: imgRight }));
};

var Section3 = function Section3() {
  return _react2.default.createElement('div', { className: 'feature-callout feature-content-center image-cover' }, _react2.default.createElement('div', { className: 'feature-callout-cover has-overlay', style: imgCenter }, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'callout-feature-content' }, _react2.default.createElement('h2', null, 'Culpa distinctio nemo'), _react2.default.createElement('p', null, 'Cupiditate at maiores dignissimos, nesciunt quam porro accusantium velit quas? Nam nobis, deleniti inventore consequuntur quos vero voluptatum nostrum error porro mollitia, accusantium distinctio nemo expedita ipsum quisquam laboriosam.'), _react2.default.createElement(_RaisedButton2.default, { label: 'Try it Now', secondary: true })))));
};

var FeatureCallouts = function FeatureCallouts() {
