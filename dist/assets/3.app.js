...
var ForgotPassowrd = function (_React$Component) {
  _inherits(ForgotPassowrd, _React$Component);

  function ForgotPassowrd() {
    _classCallCheck(this, ForgotPassowrd);

    var _this = _possibleConstructorReturn(this, (ForgotPassowrd.__proto__ || Object.getPrototypeOf(ForgotPassowrd)).call(this));
  ...
  _createClass(ForgotPassowrd, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', { className: 'body-inner' }, _react2.default.createElement('div', { className: 'card bg-white' }, _react2.default.createElement('div', { className: 'card-content' }, _react2.default.createElement('section', { className: 'logo text-center' }, _react2.default.createElement('h1', null, _react2.default.createElement('a', { href: '#/' }, this.state.brand))), _react2.default.createElement('form', null, _react2.default.createElement('fieldset', null, _react2.default.createElement('div', { className: 'form-group' }, _react2.default.createElement(_TextField2.default, {
        floatingLabelText: 'Email',
        type: 'email',
        fullWidth: true
      }), _react2.default.createElement('div', { className: 'additional-info text-center text-small' }, 'Enter your email address that you used to register. We\'ll send you an email with your username and a link to reset your password.'))))), _react2.default.createElement('div', { className: 'card-action no-border text-right' }, _react2.default.createElement('a', { href: '#/', className: 'color-primary' }, 'Reset'))));
    }
  }]);
...
var Page = function Page() {
  return _react2.default.createElement('div', { className: 'page-forgot' }, _react2.default.createElement('div', { className: 'main-body' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(ForgotPassowrd, null)))));
};
