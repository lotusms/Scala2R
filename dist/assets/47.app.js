...
var Blog = function (_React$Component) {
  ...
  function Blog() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Blog.__proto__ || Object.getPrototypeOf(Blog)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      posts: posts
  ...
  _createClass(Blog, [{
    ...
    value: function render() {
      return _react2.default.createElement('section', { className: 'page-blog container-fluid no-breadcrumbs with-maxwidth-md chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, this.state.posts.map(function (post, index) {
        return _react2.default.createElement('article', { className: 'blog-item', key: index }, _react2.default.createElement('h2', null, _react2.default.createElement('a', { href: 'javascript:;' }, post.title)), _react2.default.createElement('div', { className: 'blog-info' }, _react2.default.createElement('span', null, _react2.default.createElement('img', { src: post.avatar, alt: 'avatar', className: 'avatar' })), _react2.default.createElement('span', null, _react2.default.createElement('a', { href: 'javascript:;', className: 'author' }, post.author)), _react2.default.createElement('span', { className: 'date' }, '10 June'), _react2.default.createElement('span', { className: 'category' }, _react2.default.createElement('a', { href: 'javascript:;' }, post.category))), _react2.default.createElement('p', { className: 'desc' }, 'Consequuntur hic eum ab consequatur, veniam laudantium placeat pariatur numquam quo voluptatem velit, labore voluptas tempore temporibus vitae tenetur porro eligendi exercitationem fugiat ipsum in ullam. Necessitatibus laboriosam enim ea eos, eveniet corporis impedit. Lorem ipsum dolor sit amet, consectetur adipisicing elit.'));
      })));
    }
  }]);
