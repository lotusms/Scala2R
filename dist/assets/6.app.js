...
var ConfirmEmail = function ConfirmEmail() {
  return _react2.default.createElement('div', { className: 'body-inner' }, _react2.default.createElement('div', { className: 'card bg-color-white' }, _react2.default.createElement('div', { className: 'card-content' }, _react2.default.createElement('div', { className: 'logo text-center' }, _react2.default.createElement('a', null, 'Confirm Email')), _react2.default.createElement('div', null, _react2.default.createElement('p', { className: 'confirm-mail-icon' }, _react2.default.createElement('span', { className: 'material-icons' }, 'mail_outline')), _react2.default.createElement('p', { className: 'text-center text-small no-margin' }, 'An email has been send to ', _react2.default.createElement('strong', null, 'username@mail.com'), '. Please check for an email from us and click on the included link to reset your password.')))), _react2.default.createElement('div', { className: 'additional-info' }, _react2.default.createElement('span', null, 'Return to ', _react2.default.createElement('a', { href: '#/login' }, 'Login'))));
};

var Page = function Page() {
  return _react2.default.createElement('div', { className: 'page-auth page-confirm-email' }, _react2.default.createElement('div', { className: 'main-body' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(ConfirmEmail, null)))));
};
