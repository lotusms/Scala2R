...
var Hero = function Hero() {
  return _react2.default.createElement('article', { className: 'article' }, _react2.default.createElement('section', { className: 'hero' }, _react2.default.createElement('div', { className: 'hero-content' }, _react2.default.createElement('h1', { className: 'hero-title' }, 'How can we help you?')), _react2.default.createElement('p', { className: 'hero-tagline' }, 'Feel free to contact us if you have any questions')));
};

var Contact = function Contact() {
  return _react2.default.createElement('article', { className: 'article article-dark' }, _react2.default.createElement('h2', { className: 'article-title text-center no-margin-top' }, 'Contact Us'), _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-6' }, _react2.default.createElement('div', { className: 'box box-transparent' }, _react2.default.createElement('div', { className: 'box-body padding-lg-h' }, _react2.default.createElement('h4', null, 'Get In Touch'), _react2.default.createElement('p', null, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. A consectetur necessitatibus ea possimus est quis cumque vel saepe. Eum, quas, ducimus.'), _react2.default.createElement('div', { className: 'divider divider-solid' }), _react2.default.createElement('p', null, '123 Mountain View ', _react2.default.createElement('br', null), ' Santa Clara, C.A. ', _react2.default.createElement('br', null), ' USA'), _react2.default.createElement('div', { className: 'divider divider-solid' }), _react2.default.createElement('p', null, _react2.default.createElement('strong', null, 'E:'), ' mail@site.com', _react2.default.createElement('br', null), _react2.default.createElement('strong', null, 'P:'), ' +1 234 56789', _react2.default.createElement('br', null), _react2.default.createElement('strong', null, 'S:'), ' www.site.com')))), _react2.default.createElement('div', { className: 'col-xl-6' }, _react2.default.createElement('div', { className: 'box box-transparent' }, _react2.default.createElement('div', { className: 'box-body padding-lg-h' }, _react2.default.createElement('h4', null, 'Contact'), _react2.default.createElement('form', { name: 'contactForm' }, _react2.default.createElement('div', { className: 'form-group' }, _react2.default.createElement(_TextField2.default, {
    hintText: 'Name',
    fullWidth: true
  })), _react2.default.createElement('div', { className: 'form-group' }, _react2.default.createElement(_TextField2.default, {
    hintText: 'Email',
    fullWidth: true
  })), _react2.default.createElement('div', { className: 'form-group' }, _react2.default.createElement(_TextField2.default, {
    hintText: 'Message',
    ...
    multiLine: true,
    rows: 3
  })), _react2.default.createElement('div', { className: 'divider' }), _react2.default.createElement(_RaisedButton2.default, { primary: true, label: 'Submit' }))))))));
};

var Page = function Page() {
  return _react2.default.createElement('section', { className: 'chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Hero, null)), _react2.default.createElement('div', { key: '2' }, _react2.default.createElement(Contact, null))));
};
