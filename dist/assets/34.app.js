...
var Sashes = function (_React$Component) {
  _inherits(Sashes, _React$Component);
  ...
  function Sashes() {
    ...
    _classCallCheck(this, Sashes);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sashes.__proto__ || Object.getPrototypeOf(Sashes)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      products: products
  ...
  _createClass(Sashes, [{
    ...
    value: function render() {
      return _react2.default.createElement('section', { className: 'container-fluid with-maxwidth no-breadcrumbs chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement('div', { className: 'row' }, this.state.products.map(function (product, index) {
        return _react2.default.createElement('div', { className: 'col-xl-3 col-lg-6', key: index }, _react2.default.createElement('a', { href: 'javascript:;', className: 'item-card' }, _react2.default.createElement('div', { className: (0, _classnames2.default)('sash sash-triangle-right', product.sash) }, _react2.default.createElement('div', null, _react2.default.createElement('i', { className: 'material-icons' }, product.sash_icon), _react2.default.createElement('span', { className: 'sash-text' }, product.sash_text))), _react2.default.createElement('div', { className: 'card__image' }, _react2.default.createElement('img', { alt: 'product', src: product.img })), _react2.default.createElement('div', { className: 'card__body card-white' }, _react2.default.createElement('div', { className: 'card__title' }, _react2.default.createElement('h6', null, 'Accessories'), _react2.default.createElement('h4', null, product.name)), _react2.default.createElement('div', { className: 'card__price' }, _react2.default.createElement('span', { className: 'type--strikethrough' }, '$699.99'), _react2.default.createElement('span', null, '$649.99')))));
      })))));
    }
  }]);
