...
var Hero = function Hero() {
  return _react2.default.createElement('section', { className: 'hero' }, _react2.default.createElement('div', { className: 'hero-content' }, _react2.default.createElement('h1', { className: 'hero-title' }, 'FAQs')), _react2.default.createElement('p', { className: 'hero-tagline' }, 'Frequently Asked Questions'));
};

var FAQs = function FAQs() {
  return _react2.default.createElement('article', { className: 'article padding-lg-v article-dark article-bordered' }, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-6' }, _react2.default.createElement('h4', null, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit?'), _react2.default.createElement('p', null, 'BEligendi amet quam inventore nam nostrum quaerat aliquam enim dicta illo laboriosam, quia odio voluptas animi consequatur non nemo deleniti, illum tempore assumenda reprehenderit corporis vel impedit nihil earum. Voluptas explicabo voluptatem iste libero officia cum voluptate, qui laboriosam atque.'), _react2.default.createElement('div', { className: 'divider divider-xl divider-dashed' }), _react2.default.createElement('h4', null, 'Doloribus dolores, officia voluptatibus deserunt ratione debitis laboriosam?'), _react2.default.createElement('p', null, 'Ut tempora, ad eos. Eveniet asperiores quaerat cupiditate quo, possimus officiis deserunt porro dolor mollitia iure minima id incidunt facilis accusamus ea quod perferendis veniam quas, et distinctio dolores corporis magni sapiente hic. Non saepe, veritatis, molestias debitis illum, quasi optio modi numquam harum repellat dolorem, velit blanditiis aliquid eveniet iusto! Sed reiciendis, tempora ex dolor fugiat temporibus, iste!'), _react2.default.createElement('div', { className: 'divider divider-xl divider-dashed' }), _react2.default.createElement('h4', null, 'Illo recusandae beatae facilis?'), _react2.default.createElement('p', null, 'Facere quo corporis distinctio recusandae pariatur possimus veniam ipsa assumenda autem, qui laborum molestias, magnam sed, voluptas optio illo. Illo, minima officia, labore ipsa fugiat, cum magnam ad error, nobis placeat suscipit? Enim magni delectus, sit, deserunt, repudiandae ratione hic et, libero nemo doloremque numquam quibusdam obcaecati pariatur dolorem.'), _react2.default.createElement('div', { className: 'divider divider-xl divider-dashed' }), _react2.default.createElement('h4', null, 'Quidem doloribus, repudiandae?'), _react2.default.createElement('p', null, 'Veniam optio iste aliquid dicta labore perspiciatis pariatur modi. Explicabo quisquam tenetur consectetur at possimus laborum aliquam a magni nulla veritatis accusamus consequuntur dolorem doloremque fugiat earum vero quos sit cumque saepe maiores sint, beatae ab..'), _react2.default.createElement('p', null, 'Nemo sed ipsa consequatur facere saepe dolore velit magni autem laborum exercitationem sequi animi vel necessitatibus veritatis, a aliquam voluptas voluptatum vitae qui harum, repellendus. Ut pariatur dignissimos dolore in repudiandae porro quos a delectus doloribus odit, maxime magnam eius soluta dolorum! Recusandae illum perferendis, expedita voluptates')), _react2.default.createElement('div', { className: 'col-xl-6' }, _react2.default.createElement('h4', null, 'Assumenda accusamus reiciendis obcaecati iusto?'), _react2.default.createElement('p', null, 'Delectus provident dolorum quam quae, facere dolore sint modi eius ut enim distinctio. Ratione adipisci fugiat deserunt provident tempora? Reprehenderit, perspiciatis excepturi fugiat neque atque tenetur nesciunt cum perferendis dolor ullam similique iure nulla amet, delectus consequuntur qui quaerat unde quidem assumenda!'), _react2.default.createElement('p', null, 'At quis accusamus distinctio enim quaerat laudantium veniam laborum impedit cumque, minima porro. Aliquam laborum, tempore totam temporibus ea obcaecati at aut omnis fugit natus, doloribus, labore pariatur molestias velit veritatis?'), _react2.default.createElement('div', { className: 'divider divider-xl divider-dashed' }), _react2.default.createElement('h4', null, 'Alias harum culpa earum cum id aspernatur repellendus aliquam?'), _react2.default.createElement('p', null, 'Officia placeat vero ut quis perspiciatis ad doloribus. Voluptatum unde eaque magni ullam, veniam non illo doloremque ducimus voluptatibus quisquam, labore aspernatur ipsam optio sed necessitatibus culpa numquam vel, earum, autem porro laborum reprehenderit nulla. Nam quo, sunt, nesciunt ipsum architecto ipsa cumque minima reprehenderit dignissimos quod rem, amet deserunt, cupiditate dicta!'), _react2.default.createElement('p', null, 'Natus omnis quam ad, repellat similique nesciunt, quia molestias obcaecati itaque odio animi eaque distinctio error ipsa. Dolore quod vel possimus minima, maxime aperiam magni omnis nemo ex ipsa doloribus quidem adipisci eius fugit dignissimos praesentium velit quis, et totam, tempore necessitatibus doloremque!'), _react2.default.createElement('div', { className: 'divider divider-xl divider-dashed' }), _react2.default.createElement('h4', null, 'Optio doloremque suscipit aut accusantium maxime provident cumque?'), _react2.default.createElement('p', null, 'Unde repudiandae repellat in eos, ullam, hic eveniet dolorum dignissimos illum voluptates adipisci animi vel, aspernatur quaerat quos. Accusamus nihil odit quia, eligendi molestiae necessitatibus blanditiis beatae delectus nulla quidem. Blanditiis molestias harum iste ad iure corporis culpa ratione nulla est similique incidunt nisi tempore ea dignissimos, laudantium, sequi deleniti porro veritatis. Maiores nihil, dignissimos magnam beatae quae quia natus eligendi et, quos quas. Mollitia laboriosam, magni at minus veniam voluptates ad dolor aliquid quisquam nobis maiores dolorum repudiandae, iste ea alias pariatur consectetur voluptatibus ullam repellat autem tempore necessitatibus explicabo nisi.')))));
};

var Page = function Page() {
  return _react2.default.createElement('section', { className: 'page-faq chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Hero, null)), _react2.default.createElement('div', { key: '2' }, _react2.default.createElement(FAQs, null))));
};
