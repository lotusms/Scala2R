...
var Section1 = function Section1() {
  return _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('article', { className: 'article' }, _react2.default.createElement('h2', { className: 'article-title' }, 'Basic'), _react2.default.createElement('div', { className: 'box box-default' }, _react2.default.createElement('div', { className: 'box-body' }, _react2.default.createElement('div', { className: 'call-to-action cta-inline' }, _react2.default.createElement('div', { className: 'cta-inner' }, _react2.default.createElement('span', { className: 'cta-text' }, 'Download it now and get up and running in minutes'), _react2.default.createElement('div', { className: 'cta-btn' }, _react2.default.createElement(_RaisedButton2.default, { style: mWidthStyle, label: 'Free Download', secondary: true }))))))));
};

var Section2 = function Section2() {
  return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('article', { className: 'article no-margin-bttom' }, _react2.default.createElement('h2', { className: 'article-title' }, 'Full Width (Inline)'))), _react2.default.createElement('div', { className: 'call-to-action cta-inline cta-full-width card-white' }, _react2.default.createElement('div', { className: 'cta-inner' }, _react2.default.createElement('span', { className: 'cta-text' }, 'Download it now and get up and running in minutes'), _react2.default.createElement('div', { className: 'cta-btn' }, _react2.default.createElement(_RaisedButton2.default, { style: mWidthStyle, label: 'Free Download', secondary: true })))), _react2.default.createElement('div', { className: 'divider' }));
};

var Section3 = function Section3() {
  return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('article', { className: 'article no-margin-bttom' }, _react2.default.createElement('h2', { className: 'article-title' }, 'Full Width'))), _react2.default.createElement('div', { className: 'call-to-action cta-full-width card-white' }, _react2.default.createElement('div', { className: 'cta-inner' }, _react2.default.createElement('span', { className: 'cta-text' }, 'Download it now and get up and running in minutes'), _react2.default.createElement('div', { className: 'cta-btn' }, _react2.default.createElement(_RaisedButton2.default, { style: mWidthStyle, label: 'Free Download', secondary: true })), _react2.default.createElement('div', { className: 'cta-muted' }, 'No spam! We promise, only the best stuff.'))), _react2.default.createElement('div', { className: 'divider' }));
};

var Section4 = function Section4() {
  return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'container-fluid with-maxwidth' }, _react2.default.createElement('article', { className: 'article no-margin-bttom' }, _react2.default.createElement('h2', { className: 'article-title' }, 'Image Background'))), _react2.default.createElement('div', { className: 'call-to-action cta-bg-img cta-full-width', style: { backgroundImage: 'url(assets/images-demo/covers/photo-1456374407032-6e4baf58fb62.jpg)' } }, _react2.default.createElement('div', { className: 'cta-inner' }, _react2.default.createElement('span', { className: 'cta-text' }, 'Download it now and get up and running in minutes'), _react2.default.createElement('div', { className: 'cta-btn' }, _react2.default.createElement(_RaisedButton2.default, { style: mWidthStyle, label: 'Free Download', secondary: true })), _react2.default.createElement('div', { className: 'cta-muted' }, 'No spam! We promise, only the best stuff.'))));
};

var CallToActions = function CallToActions() {
  return _react2.default.createElement('section', { className: 'chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Section1, null)), _react2.default.createElement('div', { key: '2' }, _react2.default.createElement(Section2, null)), _react2.default.createElement('div', { key: '3' }, _react2.default.createElement(Section3, null)), _react2.default.createElement('div', { key: '4' }, _react2.default.createElement(Section4, null))));
};
