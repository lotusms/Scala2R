...
var _Config = __webpack_require__(290);
...
var Hero = function (_React$Component) {
  ...
  _createClass(Hero, [{
    ...
    value: function render() {
      return _react2.default.createElement('article', { className: 'article' }, _react2.default.createElement('section', { className: 'hero' }, _react2.default.createElement('div', { className: 'hero-content' }, _react2.default.createElement('h1', { className: 'hero-title' }, 'Careers at ', this.state.brand)), _react2.default.createElement('p', { className: 'hero-tagline' }, 'We\u2019re a small startup, so everyone has a huge impact.'), _react2.default.createElement('div', { className: 'hero-action' }, _react2.default.createElement(_RaisedButton2.default, { label: 'View Openings' }))));
    }
  }]);
...
var Why = function Why() {
  return _react2.default.createElement('article', { className: 'article' }, _react2.default.createElement('h2', { className: 'article-title text-center no-margin-top' }, 'Why working here'), _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'devices'))), _react2.default.createElement('h3', null, 'Your own laptop'), _react2.default.createElement('p', null, 'Choose the laptop you want, normally it\'s a Macbook air or Macbook Pro.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'access_time'))), _react2.default.createElement('h3', null, 'Flexible work hours'), _react2.default.createElement('p', null, 'Choose hours that work well for you and your life. We\u2019re not all 9 to 5 here.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'directions_bike'))), _react2.default.createElement('h3', null, 'A new bike'), _react2.default.createElement('p', null, 'Getting around San Francisco is the best way to see the city all year round.')))), _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'attach_money'))), _react2.default.createElement('h3', null, 'Competitive Compensation'), _react2.default.createElement('p', null, 'We offer salaries and equity that compete with any tech company in the city.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'local_hospital'))), _react2.default.createElement('h3', null, 'Healthcare Coverage'), _react2.default.createElement('p', null, 'Have access to the best health coverage so you know you and your family are covered.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'people_outline'))), _react2.default.createElement('h3', null, 'Friendly colleague'), _react2.default.createElement('p', null, 'All your colleague are friendly, you\'ll have fun working here.')))), _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'card_giftcard'))), _react2.default.createElement('h3', null, 'Monthly gift'), _react2.default.createElement('p', null, 'We will have a monthly gift for everyone, and more surprise coming on the way.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'autorenew'))), _react2.default.createElement('h3', null, 'Free Gym Membership'), _react2.default.createElement('p', null, 'Our office is near a gym and you can walk there whenever you want.'))), _react2.default.createElement('div', { className: 'col-xl-4' }, _react2.default.createElement('div', { className: 'icon-box ibox-plain' }, _react2.default.createElement('div', { className: 'ibox-icon' }, _react2.default.createElement('a', { href: 'javascript:;' }, _react2.default.createElement('i', { className: 'material-icons' }, 'favorite_border'))), _react2.default.createElement('h3', null, 'A Watsi Donation'), _react2.default.createElement('p', null, 'Each employee receives a Watsi donation to help improve someones life.')))));
};

var Page = function Page() {
  return _react2.default.createElement('section', { className: 'container-fluid with-maxwidth chapter' }, _react2.default.createElement(_rcQueueAnim2.default, { type: 'bottom', className: 'ui-animate' }, _react2.default.createElement('div', { key: '1' }, _react2.default.createElement(Hero, null)), _react2.default.createElement('div', { key: '2' }, _react2.default.createElement(Why, null))));
};
